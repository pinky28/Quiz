        ...
        plugin.method = {
            ...
            setupQuiz: function(options) { // use 'options' object to pass args
                ...
                if (plugin.config.quizTime && plugin.config.quizTime > 0) { 
                    $('#timeText').html('Time remaining <span id="time">' + plugin.config.quizTime + '</span>');
                } else {
                    $('#timeText').html('Elasped time <span id="time">00:00:00</span>');
                }
