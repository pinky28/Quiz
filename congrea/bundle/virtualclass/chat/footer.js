...
//        
            .text('Private Chat');
            //$(uiFooterbarUserlisttab).addClass('open' );
            //$(uiFooterbarUserlisttab).removeClass('close');
            //
            //$("#usertab_toogle_icon").addClass('icon-arrow-down');
            //$("#usertab_toogle_icon").removeClass('close icon-arrow-up');
            //
            //$(uiFooterbarUserlisttab).attr('data-title', virtualclass.lang.getString('miniUserList'));
