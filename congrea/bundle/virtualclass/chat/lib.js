...
function memberUpdate(e, addType){
    ...
    // disable the minimize icon for disabling the chat box
    $("#user_list .inner_bt #usertab_text").html("<span id='onlineusertext'>"+lang.whos + " ( " + count + " )</span>");
...
//    }    
    if (userlist.length > 0) {
        ...
        /**
         * For open the footer chat box,
         */
        //if ((virtualclass.jId  == virtualclass.gObj.uid) && !myChatBoxOpen){
