(function (window) {
    window.virtualclass = function () {
        ...
        return {
            isPlayMode :playMode,
            apps: ["Whiteboard", "ScreenShare", 'Yts', 'EditorRich', 'EditorCode','SharePresentation','Poll','Quiz'],
            ...
            init: function (urole, app, videoObj) {
                ...
                this.qzConfig ={id:"virtualclass"+this.apps[7],classes:"appOptions"};
...
//                });
                ...
                //virtualclass.videoHost.init(240 , 180);
